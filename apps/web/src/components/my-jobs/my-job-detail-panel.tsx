...
export function MyJobDetailPanel({
  ...
  async function handleSalaryOverride(data: {
    salaryMin: number | null;
    salaryMax: number | null;
    currency: string | null;
    period: string | null;
  }) {
    await updateSalaryOverride(savedJobId, data);
  }
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4">
        ...
        {postingDetail && jobDetail && !loading && (
          <div className="space-y-4">
            ...
            <SalaryOverride
              crawlerSalary={{
                min: jobDetail.posting.salaryMin,
                max: jobDetail.posting.salaryMax,
                currency: jobDetail.posting.salaryCurrency,
                period: jobDetail.posting.salaryPeriod,
              }}
              override={jobDetail.salaryOverride}
              onSave={handleSalaryOverride}
            />
