...
| # | Request | Type | Source |
|---|---------|------|--------|
| 1 | `/:lang/terms` HTML document | Static (CDN) | Pre-rendered |
| 2 | Middleware redirect | Edge function | Only if visiting `/terms` without locale prefix |
| 3-6 | JS chunks | Static (CDN) | Framework + page + TermsContent component |
...
| 10 | `/publicdomain/the_king_light.png` or `_dark.png` | Static (CDN) | Hero artwork (from `siteConfig.terms.hero.art`) |
