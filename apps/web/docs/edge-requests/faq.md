...
| # | Request | Type | Source |
|---|---------|------|--------|
| 1 | `/:lang/faq` HTML document | Static (CDN) | Pre-rendered |
| 2 | Middleware redirect | Edge function | Only if visiting `/faq` without locale prefix |
| 3-6 | JS chunks | Static (CDN) | Framework + page + FaqContent component |
...
Inherits from `(public)` layout OG image.

## Notes

- Text-only page with 12 FAQ items. No images beyond the header logo.
