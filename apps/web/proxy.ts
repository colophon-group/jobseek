...
export const config = {
  ...
  matcher: [
    ...
    "/:lang(en|de|fr|it)/company/:slug((?!(?:1-800-contacts|100ms|10a-labs|10x-genomics|11-bit-studios|11x|12twenty|15five|1global|1komma5|1mind|1password|1x|30mpc|3b-pharmaceuticals|3cloud|3red-partners|ae-studio|aechelon-technology|aecom|aeo|aerones|aerospacelab|aerospike|aerovect|aeva-inc|aevex|affect|affinidi|affirm|affirmedrx-pbc|afresh|akasa|aker-systems|akeyless|akido|akko|akkuro|aktos|akuity|akuna-capital|ao-garcia-agency|ao-globe-life|ao-shearman|ava-labs|avala|avaloq|avant|avantium|aven|avera|aviatrix|avid4|avidxchange-inc|avientus|avolta|avra|avride|azuki|azurity-pharmaceuticals-india|azurity-pharmaceuticals-us|by-the-bay-health|bybit|byd-north-america|byggmax|bystronic|bytedance|cb-insights|cbh-bank|cbre-global-workplace-solutions-data-center-solutions|dhg-deutsche-h-rakustik-gmbh|dhi-group-inc|dhl|dna-script|dnata|dndi|dnv|dycom-industries|dyna-robotics|dynamis-inc|dynamite-games|dyopath|eam-l-eveil-du-scarabee|earnin|easygo|easyjet|easymile|easypost|easyship|eaton|eawag|editasmedicine|edmentum|edmond-de-rothschild|edo|educate|edwards-lifesciences|effectual|efficient-computer|efg-international|egc-energie-und-geb-udetechnik-gmbh|egis-group|egon-zehnder|egym|eiffage|eigen-labs|eight-advisory|eikon-therapeutics|einride|epfl|epic-brokers|epic-games|epic-kids-inc|epirus|episode-six|episode-six-us|eqt-corporation|eqt-group|equal-experts|equal1|eqvilent|eraneos|ergon|ericsson|erl-pflege-gmbh|ernest|ernst-hasselbring-gmbh-co-kg|etalytics-gmbh|eth-zurich|ethereum-foundation|ethernovia-inc|ethon-ai|ethos-life|ethyca|etisalat|etoro|etsy|g-h-isolierung|g-in-gmbh|g-n-gruppe|g-p|g-research|hm-group|hmg-systems-engineering-gmbh|hmnc-brain-health|icapital|icbc|ice-miller|iceye|icici-bank|icon|iconiq|icrc|icsd|ion-group|ionity|ionos-de|ionos-se|ionq|iovance-biotherapeutics|iowa-cannabis-company|isaac|isar-aerospace|isardsat|iso|isomorphic-labs|ispot|iss-stoxx|llamaindex|lloyds|lloyds-register|llr-partners|lyceum|lydech-thermal-acoustic-solutions-tas|lyft|lyko|lynx-analytics|lyra-health|lysa|mcadams|mccullough-robertson|mcdonalds|mcg-health|mckinsey|mcmaster-carr|mco|mr-apple|mr-apple-careers-site|mrbeast|mrbeast-contract-jobs|mvz-medizinische-labore-dessau-kassel-gmbh|myers-holum|myfitnesspal|myfunded-futures|mynt|myriad360|myrspoven|myshell|mystenlabs|myvillage|pf-changs|pfasuiki-gmbh|pfizer|pflegehelden-franchise-gmbh|psi|psibufet|psiquantum|pst-professional-support-technologies-gmbh|public|public-library-of-science|publicis|pubmatic|pubnub|pulley|pulse|pulumi|pump-co|pure|rv-tech-gmbh|rvi-planning-landscape-architecture|snafu-records|snap|snap-fusion|snap-mobile-inc|snappy|sncf|snorkel-ai|snow-companies|snowflake|snyk|squarepoint-capital|squarespace|squint-ai|squircle-it-consulting-services|ti-and-m|tia|tidio|tiger|tigergraph|tight|tiktok|tilt|tilthq|tines|tint|tinybird|tipalti|tirlan|titan|titan-ai|twaice|twelve|twenty|twentyfour-industries|twilio|twin-health|twist-bioscience|twitch|two-dots|two-sigma|two-six-technologies|typeface|typeform|typewise|tytan-technologies)(?:/|$))(?:tw[^/]*|1[^/]*|ti[^/]*|et[^/]*|av[^/]*|sn[^/]*|my[^/]*|ae[^/]*|pu[^/]*|ly[^/]*|io[^/]*|ea[^/]*|ed[^/]*|ep[^/]*|mc[^/]*|cb[^/]*|er[^/]*|sq[^/]*|ak[^/]*|by[^/]*|ps[^/]*|dy[^/]*|is[^/]*|eg[^/]*|ic[^/]*|az[^/]*|ei[^/]*|mr[^/]*|pf[^/]*|eq[^/]*|hm[^/]*|g-[^/]*|rv[^/]*|a(?!(?:-|1|2|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y|z))[^/]*|dh[^/]*|ef[^/]*|ll[^/]*|ty[^/]*|3[^/]*|af[^/]*|e(?!(?:-|2|a|b|c|d|e|f|g|h|i|k|l|m|n|o|p|q|r|s|t|u|v|x|y|z))[^/]*|ao[^/]*|mv[^/]*|dn[^/]*))",
    "/:lang(en|de|fr|it)/company/:slug((?!(?:2020-companies|2k|66degrees|6sense|8am|8fleet-inc|a-lign-external|a-team|a-thinking-ape|ahti-interiors|ajax|ajax-systems|aqemia|aqr|aquatic-capital-management|away|awin|awl|aypa-power|ayuda-en-accion|bb-energy|bbpos-limited|bcg|bcge|bcs|bcv|bd|bda|bdo|bjak|bjs-wholesale-club|bnp-paribas|bny|bswift|bswift-india|btg-pactual|btig|bwe-energiesysteme-gmbh-co-kg|cd-projekt-red|cdds-ag|cfo-insights|cgi|cgs-group|cm|cma-cgm|cmblu-energy-ag|cmr-surgical|csb-bank|csem|csl|csob|css|ctc-lateral-website-linkedin|cti|ctl-gmbh|cvent|cvs-health|cvx-ventures|d2-technical-services|d2l|d2x|dlh|dlr-group|dmg-events|dphi-space|dsm-firmenich|dss-plus|dsv|dv-trading|dv01|e-s-fitness|e-star-trading-gmbh|ebanx|ebay|ehl-group|ekimetrics|ekkiden|ekn-engineering|ey|eye-security|ezcater-inc|f-e-gmbh|f-schumacher-co|f2-ai|f2g|ffg-finanzcheck-finanzportale-gmbh|fgs-global|fjallraven|fp-robotics|fti-consulting|ghost|ghx|gs-retail|gsa-capital|gsk|h-company|h-moser-cie|h2-powercell-gmbh|h3-dynamics|h3x-technologies|hca-healthcare|hcltech|hdfc-bank|hhm-hotels|hp|hp-hood|hp-inc|hp-iq|hpe|hpr|hqs-quantum-simulations|hr-block|hr-werkstatt-gmbh|hw-gr-nderkapital-gmbh|iamfluidics|ians|iata|ibex-medical-analytics|ibm|id-me|id-quantique|ideo|ideogram|idiap|ieq-capital|ifood|ifrc|ift|iherb|ihg|ilg-au-enwerbung-gmbh|ilitch|illumio|iproov|ipsy|ipx-power-usa-llc|iq|iqm|iqvia|ixl-learning|ixm|l-wen-apotheke|l3harris-technologies|lg|lg-energy-solution-arizona|lgt-group|lnfusedinnovations|ltimindtree|ltk-usa|ltse|m9-solutions|mgt-insurance|mlb-job-board-only|mq-referrals-only|ms-amlin|msc|msd|msf|mthree-recruiting-portal|mtn-group|pdf-net|pdt-partners|pdw|pjt-partners|pmaconsultants|pmg|rgt-geb-udemanagement-und-technologie-gmbh|rxr|rxsense|rzr-global-inc|s-l-connect-gmbh|sbb|sbm-management-services|sfcompute|sfox|sfs-inc|srg-ssr|srs-acquiom|ssm-health|sveriges-radio|svetness|svix|t-mobile|t-mobile-cz|t-rowe-price|tbhc-delivers|td|td-international|tnt-ventures-gmbh|tpr-education-llc)(?:/|$))(?:rg[^/]*|ct[^/]*|b(?!(?:-|1|a|b|c|d|e|g|h|i|j|k|l|m|n|o|p|r|s|t|u|v|w|y))[^/]*|cm[^/]*|lg[^/]*|m(?!(?:-|1|3|9|a|b|c|d|e|g|h|i|k|l|n|o|p|q|r|s|t|u|v|y))[^/]*|id[^/]*|a-[^/]*|aq[^/]*|s(?!(?:-|a|b|c|d|e|f|h|i|k|l|m|n|o|p|q|r|s|t|u|v|w|y))[^/]*|il[^/]*|ek[^/]*|ff[^/]*|mt[^/]*|c(?!(?:1|3|6|a|b|d|e|f|g|h|i|l|m|o|r|s|t|u|v|x|y))[^/]*|i(?!(?:2|a|b|c|d|e|f|h|k|l|m|n|o|p|q|r|s|t|u|v|x))[^/]*|t-[^/]*|d(?!(?:-|2|3|a|b|c|e|h|i|k|l|m|n|o|p|r|s|u|v|y))[^/]*|e-[^/]*|hp[^/]*|p(?!(?:2|a|d|e|f|h|i|j|l|m|n|o|p|r|s|t|u|v|w|y))[^/]*|bw[^/]*|cv[^/]*|d2[^/]*|h(?!(?:-|2|3|a|c|d|e|h|i|m|o|p|q|r|s|t|u|w|y))[^/]*|ip[^/]*|t(?!(?:-|1|a|b|d|e|h|i|j|n|o|p|r|s|u|w|x|y|z))[^/]*|h3[^/]*|sv[^/]*|sb[^/]*|ay[^/]*|cs[^/]*|ds[^/]*|hr[^/]*|ib[^/]*|gs[^/]*|f-[^/]*|lt[^/]*|pd[^/]*|bb[^/]*|bj[^/]*|f(?!(?:-|2|a|e|f|g|h|i|j|l|n|o|p|r|t|u))[^/]*|g(?!(?:-|2|a|b|e|h|i|l|o|p|r|s|u|w|x|y))[^/]*|hq[^/]*|(?![01236789abcdefghijklmnopqrstuvwxyz])[^/]+|cd[^/]*|hc[^/]*|hw[^/]*|sf[^/]*|h-[^/]*|ia[^/]*|l3[^/]*|l(?!(?:-|3|a|e|g|i|l|m|n|o|t|u|v|x|y))[^/]*|r(?!(?:a|b|e|f|g|h|i|o|s|t|u|v|w|x|z))[^/]*|ms[^/]*|bs[^/]*|sr[^/]*|td[^/]*|ln[^/]*|ml[^/]*|pm[^/]*|aj[^/]*|h2[^/]*|mq[^/]*|tn[^/]*|tp[^/]*|2[^/]*|bc[^/]*|bt[^/]*|ix[^/]*|s-[^/]*|6[^/]*|bn[^/]*|dv[^/]*|ey[^/]*|ah[^/]*|ft[^/]*|if[^/]*|l-[^/]*|rz[^/]*|8[^/]*|aw[^/]*|cg[^/]*|dl[^/]*|mg[^/]*|tb[^/]*|cf[^/]*|iq[^/]*|m9[^/]*|pj[^/]*|ez[^/]*|fp[^/]*|ie[^/]*|rx[^/]*|bd[^/]*|dm[^/]*|dp[^/]*|eb[^/]*|fg[^/]*|fj[^/]*|hh[^/]*|ss[^/]*|eh[^/]*|f2[^/]*|gh[^/]*|hd[^/]*|ih[^/]*))",
    "/:lang(en|de|fr|it)/company/:slug((?!(?:7shifts|9-mothers|a11|a16z|a24|b12|bge-inc|bhhc|bhp|bkw|bmo|bmw|bp|bvnk|c12|c3-ai|c6-bank|cx2|d3|dcaf|dkatalis|e2b|eei|eos|fhgr|fnz|g2it|gbfoods|gwi|gxo|gymshark|hsbc|httpie|i2cat|ikea-cz|irisity|iucn|ivalua|lmarena|lvmh|lxt|m-booth|m1|m3|mb-f|mbc|mdclone|mhi|mks-pamp|mntn|mphasis|p2p-org|pnc|ppro|ptc|pvh|pwc|pylon|rbc|rf-smart|rsm|rtx|rwa-xyz|sdsc|t1-energy|tjx|tsmc|tsmg|tx-group|tzdc)(?:/|$))(?:t1[^/]*|ts[^/]*|9[^/]*|a1[^/]*|bh[^/]*|dk[^/]*|gy[^/]*|mb[^/]*|mk[^/]*|rf[^/]*|tx[^/]*|bg[^/]*|bm[^/]*|c6[^/]*|gb[^/]*|ik[^/]*|ir[^/]*|lm[^/]*|m-[^/]*|md[^/]*|mp[^/]*|p2[^/]*|rw[^/]*|7[^/]*|ht[^/]*|iv[^/]*|c3[^/]*|i2[^/]*|py[^/]*|bv[^/]*|dc[^/]*|fh[^/]*|g2[^/]*|hs[^/]*|iu[^/]*|lv[^/]*|mn[^/]*|pp[^/]*|sd[^/]*|tz[^/]*|a2[^/]*|b1[^/]*|bk[^/]*|c1[^/]*|cx[^/]*|e2[^/]*|ee[^/]*|eo[^/]*|fn[^/]*|gw[^/]*|gx[^/]*|lx[^/]*|mh[^/]*|pn[^/]*|pt[^/]*|pv[^/]*|pw[^/]*|rb[^/]*|rs[^/]*|rt[^/]*|tj[^/]*|bp[^/]*|d3[^/]*|m1[^/]*|m3[^/]*))",
