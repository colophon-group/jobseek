...
def test_csv_validator_does_not_require_volatile_census_freshness():
    assert not hasattr(validator, "validate_census_freshness")
    assert not hasattr(validator, "CENSUS_FIXTURE")
