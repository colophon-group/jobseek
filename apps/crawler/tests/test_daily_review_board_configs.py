...
def test_qdrant_uses_verified_ashby_board() -> None:
    # Keep the durable board slug so sync realigns the existing board row
    # instead of disabling it and creating a second board identity.
    board = _board("qdrant-join")
