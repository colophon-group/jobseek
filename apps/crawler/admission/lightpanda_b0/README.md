...
16 URLs from four origins, in four waves. Three c1 and five c4 pairs alternate
candidate/control order. The candidate starts the merged Go producer, seeds
literal legacy schedules with producer routing off, transfers them through the
...
comparator has 1536 MiB. Both receive three CPU units. External cgroup-v2
