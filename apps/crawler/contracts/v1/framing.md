...
one record from a concatenated buffer.
...
bytes and no error is rejected instead of spinning.
...
trailing bytes, fragmented streams, ambiguous EOF, and concatenated records.
