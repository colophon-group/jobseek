...
class Settings(BaseSettings):
    ...
    # Enqueue diversion is a separate, explicit switch. Cohort and route
    # authority live only in the Go producer sidecar.
    lightpanda_b0_producer_mode: str = "off"
    lightpanda_b0_producer_socket: str = "/run/jobseek-lightpanda-producer/control.sock"
