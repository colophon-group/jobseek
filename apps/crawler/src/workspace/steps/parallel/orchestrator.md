...
3. **Decide testing strategy based on probe results:**
   ...
   **known stable ATS** — greenhouse, ashby, comeet, lever, gem, recruitee, personio,
   workday, adp, avature, bamboohr, beisen, paycom, jazzhr, jobvite, icims, gupy, cornerstone, darwinbox, dayforce, herp, hrmos, recruiterbox, keka, taleo, ukg, hirehive, hireology, paylocity, pinpoint, dvinci, traffit, rss — AND it matched with
