...
3. **Decide testing strategy based on probe results:**
   ...
   **known stable ATS** — greenhouse, ashby, comeet, lever, gem, recruitee, personio,
   workday, adp, bamboohr, beisen, paycom, jazzhr, icims, gupy, cornerstone, dayforce, herp, hrmos, recruiterbox, keka, hirehive, hireology, paylocity, pinpoint, dvinci, traffit, rss — AND it matched with
