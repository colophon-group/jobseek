...
3. **Decide testing strategy based on probe results:**
   ...
   **known stable ATS** — greenhouse, ashby, comeet, lever, gem, recruitee, personio,
   workday, bamboohr, paycom, jazzhr, icims, gupy, cornerstone, dayforce, herp, hrmos, hirehive, hireology, paylocity, pinpoint, dvinci, traffit, rss — AND it matched with
