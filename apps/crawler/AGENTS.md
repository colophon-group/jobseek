...
`.agents/skills` when present, Codex app automations for daily scheduled
routines, the Hetzner local Codex runner for the recurring company resolver,
and `codex exec --json` for traceable noninteractive fallback.
