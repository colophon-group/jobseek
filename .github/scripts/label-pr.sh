...
VALID_MONITOR_TYPES='accenture|adp|almacareer|amazon|api_sniffer|ashby|avature|bamboohr|beisen|bite|breezy|comeet|cornerstone|darwinbox|dayforce|deel|dom|dvinci|eightfold|gem|greenhouse|gupy|herp|hibob|hirehive|hireology|hrmos|icims|inline|jarvi|jazzhr|jobvite|jobylon|join|keka|kipt|lever|linkedin|mokahr|nextdata|notion|oracle_hcm|pageup|paycom|paylocity|personio|phenom|pinpoint|recruitee|recruiterbox|recruiter_co_kr|rippling|rss|sitemap|smartrecruiters|softgarden|taleo|talentbrew|traffit|ukg|umantis|workable|workday|ycombinator'
