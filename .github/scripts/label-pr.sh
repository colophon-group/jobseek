...
VALID_MONITOR_TYPES='accenture|almacareer|amazon|api_sniffer|ashby|bamboohr|bite|breezy|comeet|deel|dom|dvinci|eightfold|gem|greenhouse|herp|hibob|hirehive|hireology|hrmos|icims|inline|jazzhr|jobylon|join|kipt|lever|mokahr|nextdata|notion|oracle_hcm|paycom|paylocity|personio|phenom|pinpoint|recruitee|recruiter_co_kr|rippling|rss|sitemap|smartrecruiters|softgarden|talentbrew|traffit|umantis|workable|workday|ycombinator'
