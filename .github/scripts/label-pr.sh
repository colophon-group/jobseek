...
VALID_MONITOR_TYPES='accenture|adp|almacareer|amazon|api_sniffer|ashby|avature|bamboohr|beisen|bite|brassring|breezy|comeet|cornerstone|darwinbox|dayforce|deel|dom|dvinci|eightfold|gem|greenhouse|gupy|herp|hibob|hirehive|hireology|hrmos|icims|inline|inploi|intervieweb|jarvi|jazzhr|jobs_ch|jobvite|jobylon|join|keka|kipt|lever|linkedin|mokahr|nextdata|njoyn|notion|oracle_hcm|pageup|paycom|paylocity|personio|phenom|pinpoint|practicematch|recruitee|recruiterbox|recruiter_co_kr|rippling|rss|sitemap|smartrecruiters|softgarden|talemetry|taleo|talentbrew|traffit|turbohire|typify|ukg|umantis|welcometothejungle|workable|workday|ycombinator'
VALID_SCRAPER_TYPES='adp|api_sniffer|bite|dom|eightfold|embedded|jazzhr|json-ld|linkedin|mokahr|nextdata|notion|onlyfy|oracle_hcm|paycom|paylocity|pdf|rippling|skip|smartrecruiters|workable|workday'
