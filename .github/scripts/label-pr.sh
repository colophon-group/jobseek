...
VALID_SCRAPER_TYPES='adp|api_sniffer|bite|dom|eightfold|embedded|headhunter|infor|jazzhr|jobstreet|johdi|json-ld|linkedin|mokahr|nextdata|notion|onlyfy|oracle_hcm|paycom|paycor|paylocity|peoplesoft|pdf|phuketall|recruiterbox|rippling|seek|skip|smartrecruiters|taleo|tupu360|veryeast|workable|workday'
