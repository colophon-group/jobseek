...
VALID_MONITOR_TYPES='accenture|almacareer|amazon|api_sniffer|ashby|bite|breezy|comeet|deel|dom|dvinci|eightfold|gem|greenhouse|hibob|hirehive|hireology|inline|jobylon|join|lever|mokahr|nextdata|notion|oracle_hcm|paylocity|personio|phenom|pinpoint|recruitee|recruiter_co_kr|rippling|rss|sitemap|smartrecruiters|softgarden|talentbrew|traffit|umantis|workable|workday|ycombinator'
