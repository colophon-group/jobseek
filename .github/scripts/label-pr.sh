...
VALID_MONITOR_TYPES='accenture|almacareer|amazon|api_sniffer|ashby|bamboohr|bite|breezy|comeet|deel|dom|dvinci|eightfold|gem|greenhouse|hibob|hirehive|hireology|inline|jobylon|join|kipt|lever|mokahr|nextdata|notion|oracle_hcm|paylocity|personio|phenom|pinpoint|recruitee|recruiter_co_kr|rippling|rss|sitemap|smartrecruiters|softgarden|talentbrew|traffit|umantis|workable|workday|ycombinator'
VALID_SCRAPER_TYPES='adp|api_sniffer|bite|dom|eightfold|embedded|json-ld|mokahr|nextdata|notion|oracle_hcm|paylocity|pdf|rippling|skip|smartrecruiters|workable|workday'
