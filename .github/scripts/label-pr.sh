...
VALID_SCRAPER_TYPES='adp|api_sniffer|bite|dom|eightfold|embedded|headhunter|jazzhr|jobstreet|json-ld|linkedin|mokahr|nextdata|notion|onlyfy|oracle_hcm|paycom|paycor|paylocity|pdf|phuketall|rippling|skip|smartrecruiters|taleo|veryeast|workable|workday'
