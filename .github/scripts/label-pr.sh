...
VALID_SCRAPER_TYPES='adp|api_sniffer|bite|dom|eightfold|embedded|headhunter|jazzhr|jobstreet|json-ld|linkedin|mokahr|nextdata|notion|onlyfy|oracle_hcm|paycom|paylocity|pdf|rippling|skip|smartrecruiters|taleo|workable|workday'
