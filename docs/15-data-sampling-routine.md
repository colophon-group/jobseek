...
The production orchestrator runs on GPT-6 Astra with high reasoning. Its
project custom agents deliberately use smaller family members: Luna/low for
HTML normalization, Luna/medium for section classification, and Sol/high
...
the escalation signal instead of spending Astra tokens on every posting.
