...
| #6619 + #6624 + #6631 + #6633 integration | `/Users/Viktor/jobseek-integrate-postgres-remediation` | `codex/integrate-postgres-remediation` | root | focused/static verified; full crawler suite active |
| #6632 Typesense snapshot headroom | `/Users/Viktor/jobseek-fix-6632` | `codex/fix-6632-typesense-headroom` | root + subagent `fix_3213_api_statuses` | review-blocked; five rollout-safety corrections active |
...
| #6641 search accessibility | `/Users/Viktor/jobseek-fix-6641` | `codex/fix-6641-search-accessibility` | subagent `fix_6641_search_a11y` | active |
...
| 1 | [#6632](https://github.com/colophon-group/jobseek/issues/6632) | Typesense snapshot headroom | medium | review-blocked | `1d6984406` plus corrections active; stacked on #6620 | measured memory/staging envelope and seven days without emergency image GC |
...
| 3 | [#6641](https://github.com/colophon-group/jobseek/issues/6641) | search accessibility | medium | active | isolated implementation active | localized stable names, controls relationship, AT/keyboard check |
