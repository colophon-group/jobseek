...
| #6621 PostgreSQL backup image | `/Users/Viktor/jobseek-fix-6621` | `codex/fix-6621-postgres-backup-image` | subagent `fix_6621_postgres_backup` | merged on main as `43aa16b20`; runtime acceptance pending |
...
| #6619 + #6624 + #6631 + #6633 integration | `/Users/Viktor/jobseek-integrate-postgres-remediation` | `codex/integrate-postgres-remediation` | root | local-verified at `d2c7cb82a`; final independent review active |
...
| 0 | [#6621](https://github.com/colophon-group/jobseek/issues/6621) | web PostgreSQL backup image lifecycle | high | merged | main `43aa16b20` via PR #6656 | GC sequence, two timer cycles, fresh isolated restore |
