...
| #6618 zero-transition search counts | `/Users/Viktor/jobseek-fix-6618` | `codex/fix-6618-zero-counts` | subagent `fix_6618_zero_counts` | active |
| #6622 scheduled Typesense acknowledgements | `/Users/Viktor/jobseek-fix-6622` | `codex/fix-6622-scheduled-typesense-ack` | subagent `fix_6622_scheduled_ack` | active |
...
| 2 | [#6618](https://github.com/colophon-group/jobseek/issues/6618) | zero-transition search counts | medium | active | `codex/fix-6618-zero-counts` | every collection transitions positive counts to zero in Typesense |
| 2 | [#6622](https://github.com/colophon-group/jobseek/issues/6622) | scheduled Typesense import acknowledgements | medium | active | `codex/fix-6622-scheduled-typesense-ack` | rejected import fails cron and blocks dependent pruning |
