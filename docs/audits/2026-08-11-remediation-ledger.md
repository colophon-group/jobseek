...
| #6643 image cache configuration | `/Users/Viktor/jobseek-fix-6643` | `codex/fix-6643-image-cache` | subagent `fix_6643_image_cache` | local-verified at `aa7cbbd70`; review/live acceptance pending |
| #6644 missing-resource semantics | `/Users/Viktor/jobseek-fix-6644` | `codex/fix-6644-missing-resource-status` | subagent `fix_6644_missing_resources` | active |
...
| 3 | [#6643](https://github.com/colophon-group/jobseek/issues/6643) | image cache configuration | low | local-verified | `aa7cbbd70`; PR pending | unsupported override removed and live behavior documented |
| 3 | [#6644](https://github.com/colophon-group/jobseek/issues/6644) | missing-resource HTTP semantics | low | active | isolated implementation active | missing/public/private routes satisfy 404 and privacy contracts |
