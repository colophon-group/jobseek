...
| #5924 provider protections/labels | `/Users/Viktor/jobseek-fix-5924` | `codex/fix-5924-fleet-lifecycle` | subagent `fix_5924_provider_guardrails` | active |
...
| 1 | [#5924](https://github.com/colophon-group/jobseek/issues/5924) | fleet lifecycle/protection/reboots/images | medium | active | `cb257975e` image branch; provider branch active | protections/labels plus safe reboot and post-check evidence |
