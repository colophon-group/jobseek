...
| #6631 PostgreSQL connection budget | `/Users/Viktor/jobseek-fix-6631` | `codex/fix-6631-postgres-pool-budget` | subagent `fix_6631_pool_budget` | second-review aggregate/DSN blockers under correction |
| #6632 Typesense snapshot headroom | `/Users/Viktor/jobseek-fix-6632` | `codex/fix-6632-typesense-headroom` | root + subagent `fix_3213_api_statuses` | review-blocked; rollout/measurement/telemetry corrections active |
...
| 1 | [#6631](https://github.com/colophon-group/jobseek/issues/6631) | PostgreSQL connection budget | high | active | `41372eea5`, `3453c2843`, `211897fca`; corrections active | normal-load steady state below accepted budget and alert margin |
...
| 1 | [#6633](https://github.com/colophon-group/jobseek/issues/6633) | retired units and host logs | low | local-verified | `864625a79`; integration pending | no obsolete failed unit/container; bounded log policy verified |
