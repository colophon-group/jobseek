...
const SEED_PORTALS: PortalDefinition[] = [
  ...
  },
  {
    ...
    homepageUrl: 'https://ashbyhq.com',
    strategy: { type: 'company_probe', urlTemplate: 'https://api.ashbyhq.com/posting-api/job-board/{company}', boardUrlTemplate: 'https://jobs.ashbyhq.com/{company}' },
    status: 'active',
    suggestedBy: 'hardcoded',
    discoveredAt: new Date().toISOString(),
  },
  {
    id: 'workable',
    name: 'Workable',
    description: 'Workable ATS. Jobs at apply.workable.com/{slug}. Discovered via Wayback CDX path enumeration.',
    homepageUrl: 'https://workable.com',
    strategy: { type: 'company_probe', urlTemplate: 'https://apply.workable.com/api/v2/widget/accounts/{company}/jobs?details=1', boardUrlTemplate: 'https://apply.workable.com/{company}' },
    status: 'active',
    suggestedBy: 'hardcoded',
    discoveredAt: new Date().toISOString(),
  },
  ...
  },
  {
    ...
    strategy: {
      ...
      seedCompanies: [
        'BoschGroup', 'SephoraUSA', 'IKEA', 'McDonalds', 'Lidl',
        'Aldi', 'Carrefour', 'Vodafone', 'BNPParibas', 'Siemens',
        'BASF', 'Henkel', 'SAP', 'Zalando', 'Novartis',
        'Nestle1', 'ABBLtd', 'RocheHolding', 'ZurichInsuranceGroup', 'UBSAGb',
        'AdeccoGroup', 'Allianz', 'BMW', 'DeutscheBank', 'AXA',
        'Airbus', 'TotalEnergies', 'Renault', 'Peugeot', 'Michelin',
      ],
