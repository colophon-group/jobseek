...
For each company provide the EXACT Wayback-crawlable career portal URL (prefer in order: Workday *.myworkdayjobs.com URLs, Greenhouse boards.greenhouse.io URLs, Lever jobs.lever.co or jobs.eu.lever.co URLs, SmartRecruiters jobs.smartrecruiters.com URLs, Rippling ats.rippling.com URLs, Fountain jobs.fountain.com URLs, Workstream jobs.workstream.us URLs, Factorial factorialhr.com URLs, Teamtailor {company}.teamtailor.com URLs, Personio {company}.jobs.personio.de URLs, SAP SuccessFactors {tenant}.successfactors.com/careers URLs, Cornerstone {tenant}.csod.com/careers URLs, Eightfold careers.eightfold.ai/{company} URLs, Kenjo app.kenjo.io/{company}/jobs URLs, Dover talent.dover.com/jobs/{company} URLs, Freshteam {company}.freshteam.com/jobs URLs, Homerun {company}.homerun.co URLs, HiBob app.hibob.com/careers/{company} URLs, PageUp jobs.pageuppeople.com/{company}/go URLs, Avature careers.avature.net/{company} URLs, Hireology {company}.hireology.com/jobs URLs, Zoho Recruit {company}.zohorecruit.com/jobs/Careers URLs, Darwinbox {tenant}.darwinbox.com/ms/candidate/jobs URLs (for Indian enterprises), Keka {tenant}.keka.com/careers URLs (for Indian mid-market companies), Paycor {tenant}.paycor.com/career-portal URLs, Dayforce HCM dayforcehcm.com/CandidatePortal/en-US/{tenant} URLs (for Ceridian clients like Dollar General/Walgreens), Jobteaser jobteaser.com/en/company/{slug}/jobs URLs, or Welcome to the Jungle welcometothejungle.com/en/companies/{slug}/jobs URLs where you know them — NOT generic careers pages that redirect to ATS).
